...
public class DoritoService {
    ...
    public String getDoritoResponse(DoritoGame initialDoritoGame, List<DoritoGame> solvedDoritoGames) {
        ...
        sb.append("<table><tr><td>SOLUTION_COUNT:" + SOLUTION_COUNT + "</td></tr></table><br/>");
        sb.append("<table><tr><td>RECURSION_COUNT:" + RECURSION_COUNT + "</td></tr></table>");

        if (solvedDoritoGames != null && solvedDoritoGames.size() < MAX_SOLUTIONS_PRINT) {
